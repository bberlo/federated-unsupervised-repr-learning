...
backbone_bottleneck_f = pretrained_model.layers[2].predict([acc_train, gyr_train])[0]
backbone_bottleneck_val_f = pretrained_model.layers[2].predict([acc_eval, gyr_eval])[0]
